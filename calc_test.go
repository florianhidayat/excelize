...
func TestCalcCellValue(t *testing.T) {
	...
	mathCalc := map[string]string{
		...
		// HYPERLINK
		"=HYPERLINK(\"https://github.com/florianhidayat/excelize\")":              "https://github.com/florianhidayat/excelize",
		"=HYPERLINK(\"https://github.com/florianhidayat/excelize\",\"Excelize\")": "Excelize",
		// VLOOKUP
	...
	mathCalcError := map[string][]string{
		...
		"=HYPERLINK(\"https://github.com/florianhidayat/excelize\",\"Excelize\",\"\")": {"#VALUE!", "HYPERLINK allows at most 2 arguments"},
		// VLOOKUP
