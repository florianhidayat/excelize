...
<p align="center">
    <a href="https://github.com/florianhidayat/excelize/actions/workflows/go.yml"><img src="https://github.com/florianhidayat/excelize/actions/workflows/go.yml/badge.svg" alt="Build Status"></a>
    ...
    <a href="https://goreportcard.com/report/github.com/florianhidayat/excelize/v2"><img src="https://goreportcard.com/badge/github.com/florianhidayat/excelize/v2" alt="Go Report Card"></a>
    <a href="https://pkg.go.dev/github.com/florianhidayat/excelize/v2"><img src="https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white" alt="go.dev"></a>
...
```bash
go get github.com/florianhidayat/excelize
```

- 如果您使用 [Go Modules](https://go.dev/blog/using-go-modules) 管理软件包，请使用下面的命令来安装最新版本。

```bash
go get github.com/florianhidayat/excelize/v2
```
